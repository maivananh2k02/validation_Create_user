                    ...
                    @foreach($cart as $product)
                        <tr class="cart_item">
                            ...
                            <td class="product-name">
                                <div class="media">
                                    <img class="pull-left" src="{{asset("shopping/image/product/".$product['image'])}}" style="height: 100px" alt="">
            ...
            <div class="cart-collaterals">
                ...
                <form class="shipping_calculator pull-left" action="#" method="post">
                    ...
                    <section class="shipping-calculator-form " style="display: none;">
                        ...
                        <p>
                            <button type="submit" name="calc_shipping" value="1" class="beta-btn primary pull-right">
                                Update Totals
                            </button>
                        </p>
                    </section>
